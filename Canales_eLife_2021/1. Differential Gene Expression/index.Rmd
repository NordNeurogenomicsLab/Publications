...
subtitle: |
  | Canales et al. 2020 (under review):  
  | Perturbed embryonic cortical development   
  | and shift in neurodevelopmental timing following mid-gestational maternal immune activation. 
  |    
...
```{r, error=FALSE, warning=FALSE, message=FALSE, echo=TRUE, dev='png', dpi=72, cache=TRUE}
